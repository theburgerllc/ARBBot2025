...
async function main() {
  ...
  if (chainId === 42161n) {
    ...
    console.log(chalk.yellow("⚠️  This is a TESTNET deployment"));
    console.log(chalk.cyan("Token Addresses:"));
    console.log(chalk.white(`  WETH: 0x980B62Da83eFf3D4576C647993b0c1D7faf17c73`));
    console.log(chalk.white(`  USDC: 0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d`));
    console.log(chalk.gray(`  USDT: Not available on Sepolia`));
    console.log(chalk.gray(`  WBTC: Not available on Sepolia`));
    ...
    console.log(chalk.cyan("Token Addresses:"));
    console.log(chalk.white(`  WETH: 0x4200000000000000000000000000000000000006`));
    console.log(chalk.white(`  USDC: 0x5fd84259d66Cd46123540766Be93DFE6D43130D7`));
    console.log(chalk.gray(`  USDT: Not available on Sepolia`));
    console.log(chalk.gray(`  WBTC: Not available on Sepolia`));
  ...
  if (chainId === 42161n) {
    ...
    console.log(chalk.cyan(`   BOT_CONTRACT_ADDRESS_ARB_SEPOLIA=${deploymentInfo.contractAddress}`));
  } else if (chainId === 11155420n) {
    console.log(chalk.cyan(`   BOT_CONTRACT_ADDRESS_OPT_SEPOLIA=${deploymentInfo.contractAddress}`));
  }
  
  if (chainId === 421614n || chainId === 11155420n) {
    console.log(chalk.white("2. Get testnet ETH from faucets:"));
    if (chainId === 421614n) {
      console.log(chalk.blue("   - Arbitrum Sepolia: https://faucet.arbitrum.io/"));
    } else {
      console.log(chalk.blue("   - Optimism Sepolia: https://faucet.optimism.io/"));
    }
    console.log(chalk.white("3. Run the bot in testnet mode: npm run bot:testnet"));
  } else {
  ...
  if (chainId === 421614n || chainId === 11155420n) {
    console.log(chalk.white("• ETH/USDC (Limited testnet liquidity)"));
    console.log(chalk.gray("• ETH/USDT (Not available on testnet)"));
    console.log(chalk.gray("• WBTC/ETH (Not available on testnet)"));
    console.log(chalk.gray("• Triangular arbitrage (Limited on testnet)"));
