...
exports.LiquidityFiltering = void 0;
const axios_1 = __importDefault(require("axios"));
class LiquidityFiltering {
    providers;
    chains = {
        arbitrum: 42161,
        optimism: 10,
    ...
    async fetchTopTokensByVolatility(chainId) {
        try {
            ...
            const [dexScreenerResponse, coingeckoResponse] = await Promise.all([
                axios_1.default.get(dexScreenerUrl).catch(() => null),
                axios_1.default.get(coingeckoUrl).catch(() => null)
            ]);
            let tokens = [];
            ...
            const filteredTokens = tokens.filter(token => token.liquidity >= this.minLiquidity &&
    ...
    processDexScreenerData(pairs, chainId) {
    ...
    calculateVolatility(volume24h, volume6h, volume1h) {
    ...
    async getTopTokensForAllChains() {
        const results = {};
    ...
    async validateTokenLiquidity(tokenAddress, chainId) {
        try {
...
exports.LiquidityFiltering = LiquidityFiltering;
