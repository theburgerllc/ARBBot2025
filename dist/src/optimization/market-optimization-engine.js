...
class MarketOptimizationEngine extends events_1.EventEmitter {
    ...
    async initializeOptimization(primaryChainId) {
        ...
        try {
            ...
            this.logger.error('Failed to initialize optimization', { error: error?.message || error });
            throw error;
        }
    }
    async optimizeParameters(chainId) {
        try {
            ...
            this.logger.error('Parameter optimization failed', { error: error?.message || error, chainId });
            throw error;
        }
    }
    ...
    startOptimizationLoop(chainId) {
        ...
        this.optimizationInterval = setInterval(async () => {
            try {
                ...
                this.logger.error('Optimization loop error', { error: error?.message || error });
            }
