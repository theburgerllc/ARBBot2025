...
exports.OptimizationMonitor = void 0;
const winston = require("winston");
const events_1 = require("events");
const ethers_1 = require("ethers");
class OptimizationMonitor extends events_1.EventEmitter {
    logger;
    metrics;
    startTime;
    alertThresholds;
    ...
    logOptimizationComplete(result) {
    ...
    logOptimizationError(error, context) {
    ...
    logParameterValidation(originalParameters, validatedParameters, warnings, errors) {
    ...
    logTradeExecution(approved, parameters, profit, gasCost, executionTime) {
        this.logger.info('Trade execution with optimized parameters', {
            event: 'trade.execution',
            approved,
            profit: (0, ethers_1.formatEther)(profit),
            gasCost: (0, ethers_1.formatEther)(gasCost),
            netProfit: (0, ethers_1.formatEther)(profit - gasCost),
            executionTime,
    ...
    logPerformanceMetrics(metrics) {
        this.logger.info('Performance metrics updated', {
            ...
            metrics: {
                ...
                averageProfit: (0, ethers_1.formatEther)(metrics.averageProfit),
    ...
    logMarketConditions(conditions) {
    ...
    logSystemHealth(status, details) {
    ...
    formatParametersForLogging(parameters) {
        return {
            minProfitThreshold: (0, ethers_1.formatEther)(parameters.minProfitThreshold),
            slippageTolerance: `${parameters.slippageTolerance}bp`,
            maxTradeSize: (0, ethers_1.formatEther)(parameters.maxTradeSize),
            gasSettings: {
...
exports.OptimizationMonitor = OptimizationMonitor;
